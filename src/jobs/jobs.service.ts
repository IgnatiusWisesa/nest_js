...
export class JobsService {
    constructor(@InjectModel('Job') private readonly jobModel: Model<Job>){}
        ...
        async finds(id: string): Promise<Job> { return await this.jobModel.findOne({ _id: id }) }
        ...
        async delete(id: string): Promise<Job> { return await this.jobModel.findByIdAndRemove(id) }
}
